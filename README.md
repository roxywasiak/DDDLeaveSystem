...
| Build | Maven |
| Testing | JUnit 5 · Mockito · MockMvc — 63 tests |
...
All 63 tests run against an in-memory H2 database — no external dependencies required.
